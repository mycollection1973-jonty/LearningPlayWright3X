...
let validName = "start with letter";
let _private = "start with underscore";
let $jquery = "start with dollar sign";

let item1 = "letter then digit";
let _item2 = "underscore then digit";
let $var123 = "dollar then digit";
let a1_b2 = "mixed letters digits uderscore";
